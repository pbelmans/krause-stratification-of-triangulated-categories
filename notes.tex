...
\begin{remark}
  ...
  \begin{equation}
    \begin{aligned}
      ...
      \image Q_\rho&={}^\perp\SSing(\Qcoh/X).% TODO improve perp
    \end{aligned}
  \end{equation}
\end{remark}
...
\begin{proposition}
  For all~$\mathfrak{p}\in\Spec R$ there exists an exact quotient\fixthis{localisation?} functor~$\mathcal{T}\to\mathcal{T}_{\mathfrak{p}}:X\mapsto X_{\mathfrak{p}}$ such that
  \begin{equation}
